...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= base_url('/admin/tambah_siswaeskul') ?>" method="post">
            <div class="form-group">
                <label>Nama Ekstrakulikuler</label>
                <select class="form-control" name="nama_eskul" id="nama_eskul">
...
<?php if (isset($_POST['cari_siswa'])) : ?>
    <div class="card mt-3">
        <form action="<?= base_url('/admin/val_tambah_siswaeskul') ?>" method="post">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Nama Ekstrakulikuler</label>
                            <input type="text" name="nama_eskul" id="nama_eskul" class="form-control" value="<?= $_POST['nama_eskul'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="table-responsive mt-2">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody class="text-center">
                            <?php foreach ($Siswa->like('tahun_mendaftar', $_POST['tahun_siswa'])->find() as $data) : ?>
                                <tr>
                                    <td><?= $data['nisn'] ?></td>
                                    <td><?= $data['nama'] ?></td>
                ...
                <a href="<?= base_url('/admin/data_siswaeskul') ?>" class="btn btn-danger mt-2 ml-2">Kembali</a>
            </div>
        </form>
    </div>
<?php endif; ?>
