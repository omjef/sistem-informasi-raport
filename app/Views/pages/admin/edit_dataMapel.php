...
<div class="card">
    ...
    <div class="card-body">
        ...
        <?php endif; ?>
        <form action="<?= base_url('/admin/val_edit_datamapel') ?>" method="post">
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="id_mapel">ID MATAPELAJARAN</label>
                        <input type="text" class="form-control <?= ($validation->hasError('id_mapel')) ? 'is-invalid' : ''; ?>" name="id_mapel" id="id_mapel" placeholder="Masukan id mata pelajaran" value="<?= $dataMapel['id_mapel'] ?>">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nama_mapel')) ? 'is-invalid' : ''; ?>" name="nama_mapel" id="nama_mapel" placeholder="Masukan id mata pelajaran" value="<?= $dataMapel['nama_mapel'] ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="aspek" id="aspek">
                            ...
                            <option value="Pengetahuan" <?= ($dataMapel['aspek'] == 'Pengetahuan') ? 'selected' : ''; ?>>Pengetahuan</option>
                        </select>
                    </div>
                </div>
            </div>
